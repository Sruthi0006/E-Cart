...
function Footer() {
  return (
    <div className='py-5 md:px-20 px-10 bg-indigo-950 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)]  text-white'>
      ...
      <div>
        ...
        <p className='mt-5'>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quos id perspiciatis enim ullam alias quaerat repellat at eveniet eaque quidem non est, earum et aliquid laboriosam mollitia cumque modi qui!
        </p>
      </div>
